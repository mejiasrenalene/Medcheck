...
<head>
<meta charset="UTF-8">
<title>Session Booking - Medcheck</title>
...
<div class="page-header">
    ...
    <p>Book your appointment with verified medical specialists.</p>
</div>

<!-- SEARCH -->
<div class="card search-card">
<form method="post" class="search-form">
    <input type="search" name="search" placeholder="Search doctor, session title or date...">
    <button type="submit">
...
<!-- HEADER INFO -->
<div class="card">
    <h3><i class="fa-solid fa-list"></i> Sessions Found: <?php echo $result->num_rows; ?></h3>

    <?php if($keyword!=""){ ?>
        <p><i class="fa-solid fa-magnifying-glass"></i> Search result: <b><?php echo $keyword; ?></b></p>
    <?php } ?>
</div>
...
if($result->num_rows==0){
    ...
    echo "
    <div class='card'>
        <h3><i class='fa-solid fa-circle-xmark'></i> No Sessions Found</h3>
    ...
    while($row=$result->fetch_assoc()){
        ...
        <div class='session-card'>
            ...
            <div class='session-body'>
                <p><i class='fa-solid fa-user-doctor'></i> <b>Doctor:</b> $doc</p>
                <p><i class='fa-solid fa-calendar'></i> <b>Date:</b> $date</p>
                <p><i class='fa-solid fa-clock'></i> <b>Time:</b> $timeFormatted</p>
            </div>

            <div class='session-footer'>
                <a href='booking.php?id=$id'>
                    <button class='book-btn'>
                        <i class='fa-solid fa-calendar-plus'></i> Quick Book
                    </button>
                </a>
            </div>
